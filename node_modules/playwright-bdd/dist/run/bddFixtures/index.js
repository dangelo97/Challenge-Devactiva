...
exports.test = test_1.test.extend({
    ...
    Given: ({ $bddWorld, $before, $applySpecialTags }, use) => use(new StepInvoker_1.StepInvoker($bddWorld, 'Given').invoke),
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    When: ({ $bddWorld, $before, $applySpecialTags }, use) => use(new StepInvoker_1.StepInvoker($bddWorld, 'When').invoke),
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    Then: ({ $bddWorld, $before, $applySpecialTags }, use) => use(new StepInvoker_1.StepInvoker($bddWorld, 'Then').invoke),
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    And: ({ $bddWorld, $before, $applySpecialTags }, use) => use(new StepInvoker_1.StepInvoker($bddWorld, 'And').invoke),
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    But: ({ $bddWorld, $before, $applySpecialTags }, use) => use(new StepInvoker_1.StepInvoker($bddWorld, 'But').invoke),
